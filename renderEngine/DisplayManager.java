...
public class DisplayManager {
    ...
    private static String getTitle(){
        String[] phrases = {
                ...
                "Built with love and coffee stains.",
                "100% unicorn-free!",
                "Still safer than hiking!",
                "Less expensive than therapy.",
                "Like a workout, but for your thumbs.",
                "Game calories don’t count, right?",
                "No vegetables were harmed in the making.",
                "More addictive than mom’s pumpkin pie!",
                "Happier than a seagull with a stolen chip.",
                "Satisfaction guaranteed, or your boredom back.",
                "Batteries not included, cause it doesn’t need any.",
                ...
                "Your social life called, it misses you.",
                ...
                "Introvert's paradise.","NotAllowed yet banned in the real world!",
        ...
        int phrase = (int) (Math.random() * 100);
