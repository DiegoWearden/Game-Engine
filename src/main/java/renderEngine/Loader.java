...
public class Loader {
    ...
    public int loadTexture(String fileName){
        ...
        try {
            texture = TextureLoader.getTexture("PNG", Files.newInputStream(Paths.get("src/res/" + fileName + ".png")));
    ...
    private void storeDataAttributeList(int attributeNumber, int coordianteSize, float[] data){
