...
public class MainGameLoop {
	...
	public static void main(String[] args) throws LWJGLException {
		String lwjglLibraryPath = new File("src/javalib").getAbsolutePath();

		// Set the LWJGL library path dynamically
		System.setProperty("org.lwjgl.librarypath", lwjglLibraryPath);
